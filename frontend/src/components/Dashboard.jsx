...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8 w-full max-w-7xl mx-auto space-y-6 md:space-y-10">
      <div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <motion.div 
              ...
              className="bg-gradient-to-br from-primary/20 to-surface border border-primary/30 rounded-[1.5rem] md:rounded-[2.5rem] p-4 md:p-6 shadow-xl relative overflow-hidden group hover:border-primary/50 transition-all hover:scale-[1.02]"
            >
              ...
              <h3 className="text-[9px] md:text-[11px] font-black uppercase tracking-widest text-textMuted mb-1">{stat.title}</h3>
              <p className="text-xl md:text-3xl font-black text-textMain tracking-tight">{loading ? '...' : stat.value}</p>
            </motion.div>
          );
        })}
      </div>
