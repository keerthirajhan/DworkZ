...
const Visitors = () => {
  ...
  const handleCheckIn = async (e) => {
    ...
    try {
      ...
      setFormData({ name: '', companyName: '', personToVisit: '', purpose: 'Day Pass', email: '', aadharNumber: '', otp: '' });
      setCapturedImage(null);
      setOtpSent(false);
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-10">
                    ...
                    <div className="space-y-1.5">
                      <p className="text-[10px] text-textMuted uppercase font-bold">Government ID</p>
