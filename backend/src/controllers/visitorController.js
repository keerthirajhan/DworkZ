...
exports.sendOTP = async (req, res) => {
  ...
  try {
    ...
    console.log(`\x1b[33m[BYPASS]\x1b[0m Returning OTP directly to frontend: \x1b[36m${otp}\x1b[0m`);
    return res.status(200).json({ 
      success: true, 
      message: 'OTP generated (Email delivery failed or SMTP not configured. Bypassed: OTP returned directly)',
      devOtp: otp 
    });
  }
